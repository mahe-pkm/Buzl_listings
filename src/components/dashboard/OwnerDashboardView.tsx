...
import { OwnerDashboardData } from '@/lib/dashboard-data';
  ...
  return (
    <>
      <Topbar
        ...
        subtitle={`Signed in as ${userEmail || 'Business Owner'}`}
        userEmail={userEmail}
        isAdmin={false}
        action={{
          label: 'Add Business',
      ...
      <main className="p-4 sm:p-6 space-y-6 flex-1 max-w-7xl w-full mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <div className="bg-white p-5 rounded-[8px] border border-[#DCE2E8] shadow-xs">
            ...
            <div className="text-2xl font-bold text-[#2A3547] mt-1">{kpis.total}</div>
          ...
          <div className="bg-white p-5 rounded-[8px] border border-[#DCE2E8] shadow-xs">
            ...
            <div className="text-2xl font-bold text-[#087C3C] mt-1">{kpis.published}</div>
          ...
          <div className="bg-white p-5 rounded-[8px] border border-[#DCE2E8] shadow-xs">
            ...
            <div className="text-2xl font-bold text-[#D99B18] mt-1">{kpis.pending}</div>
          ...
          <div className="bg-white p-5 rounded-[8px] border border-[#DCE2E8] shadow-xs">
            ...
            <div className="text-2xl font-bold text-[#2A3547] mt-1">{kpis.draft}</div>
                ...
                <tbody className="divide-y divide-[#DCE2E8] text-xs text-[#2A3547]">
                  {listings.slice(0, 5).map((b) => (
                    <tr key={b.id} className="hover:bg-[#F2F5FA]/50 transition-colors">
                      ...
                      <td className="py-3.5 px-4 text-[#5D6776]">{b.category_name || '—'}</td>
